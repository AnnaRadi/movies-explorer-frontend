    ...
    return (
        <footer className="footer">
            ...
            <div className='footer__group'>
                <p className="footer__group-year">© 2023</p>
                <nav className="footer__group-link">
                    ...
                    <a className='footer__link footer__link_second' href="https://github.com/AnnaRadi" target="_blank" rel="noreferrer">Github</a>
                </nav>
            </div>
        </footer>
    );
